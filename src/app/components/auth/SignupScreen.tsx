      ...
      <div className="flex-1 px-6 pt-8 pb-8 flex flex-col overflow-y-auto">
        ...
        <div className="mt-auto pt-4">
          <button
            ...
            className="w-full text-white py-4 rounded-2xl flex items-center justify-center gap-2 transition-all active:scale-95 shadow-lg bg-orange-500 hover:bg-orange-600 shadow-orange-200"
