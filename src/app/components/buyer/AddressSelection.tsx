      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="bg-gradient-to-br from-green-100 to-blue-100 h-48 relative flex items-center justify-center border-b border-gray-200">
          <div className="text-center">
            <MapPin size={40} className="text-red-600 mx-auto mb-2" />
          ...
          >
            {isLocating ? <Loader size={20} className="animate-spin text-red-600" /> : <Navigation size={20} className="text-red-600" />}
          </button>
        </div>
        ...
        <div className="p-5 space-y-4">
              ...
              {savedAddresses.map((addr) => (
                ...
                >
                  <div className={`w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 ${
                    selectedAddress?.address === addr.address ? 'bg-red-600' : 'bg-gray-200'
                  }`}>
          ...
          <button
            ...
            className="w-full flex items-center gap-3 p-4 border-2 border-dashed border-gray-300 rounded-xl hover:border-red-500 hover:bg-red-50 transition-colors"
          >
            ...
            <div className="bg-gray-50 p-4 rounded-xl space-y-3">
              <div>
                ...
                <textarea
                  ...
                  className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500 bg-white resize-none"
                  rows={3}
                />
              </div>
              <div>
                ...
                <input
                  ...
                  className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500 bg-white"
                />
              </div>
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-red-600 text-white rounded-xl font-semibold hover:bg-red-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add Address
                </button>
              </div>
      ...
      {selectedAddress && (
        <div className="p-5 bg-white border-t border-gray-100 shadow-[0_-4px_15px_rgba(0,0,0,0.06)]">
          ...
          <button
            ...
            className="w-full bg-red-600 text-white py-4 rounded-2xl hover:bg-red-700 active:scale-95 transition-all shadow-lg shadow-red-200 font-bold"
          >
