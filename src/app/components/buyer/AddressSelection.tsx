            ...
            <div className="bg-gray-50 p-4 rounded-xl space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-red-700 text-white rounded-xl font-semibold hover:bg-red-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Add Address
                </button>
              </div>
