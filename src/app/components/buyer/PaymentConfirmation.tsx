      ...
      <MobileLayout>
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <AlertCircle size={48} className="text-red-700 mx-auto mb-3" />
    ...
    <MobileLayout>
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="px-5 py-4">
          ...
          <textarea
            ...
            className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-600 bg-gray-50 resize-none"
            rows={3}
          />
        </div>
      </div>
      ...
      <div className="p-5 bg-white border-t border-gray-100 shadow-[0_-4px_15px_rgba(0,0,0,0.06)]">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-red-700 text-white py-4 rounded-2xl hover:bg-red-800 active:scale-95 transition-all shadow-lg shadow-red-200 disabled:opacity-60 font-bold"
        >
