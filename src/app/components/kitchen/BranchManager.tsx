            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                    branchDetailsErrors.name ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                  }`}
                />
                {branchDetailsErrors.name && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.name}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                    branchDetailsErrors.address ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                  }`}
                />
                {branchDetailsErrors.address && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.address}</p>}
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                      branchDetailsErrors.openingTime ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                    }`}
                  />
                  {branchDetailsErrors.openingTime && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.openingTime}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                      branchDetailsErrors.closingTime ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                    }`}
                  />
                  {branchDetailsErrors.closingTime && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.closingTime}</p>}
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                        branchDetailsErrors.deliveryTime ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                      }`}
                    />
                    {branchDetailsErrors.deliveryTime && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.deliveryTime}</p>}
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      placeholder="150 PKR"
                      className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${
                        branchDetailsErrors.deliveryPrice ? 'border-red-300' : 'border-gray-200 focus:border-red-600'
                      }`}
                    />
                    {branchDetailsErrors.deliveryPrice && <p className="text-red-700 text-xs mt-0.5">{branchDetailsErrors.deliveryPrice}</p>}
                  </div>
                </div>
              )}
              ...
              <button
                ...
                className="w-full bg-red-700 text-white py-2.5 rounded-xl text-sm hover:bg-red-800 transition-colors"
                style={{ fontWeight: 600 }}
              >
                Save Branch Details
              </button>
        ...
        <div className="px-5 py-5 border-b border-gray-100">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="text-red-700 text-sm" style={{ fontWeight: 600 }}>
        ...
        <div className="px-5 py-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="bg-red-700 text-white rounded-full p-1.5 hover:bg-red-800 transition-colors"
            >
              <Plus size={16} />
            </button>
          </div>
          ...
          {branchRiders.length === 0 ? (
            <div className="text-center py-8 border-2 border-dashed border-gray-200 rounded-2xl">
              ...
              <button onClick={() => setShowAddRider(true)}
                className="mt-3 text-red-700 text-sm" style={{ fontWeight: 600 }}>
                + Add Rider
              </button>
            </div>
          ) : (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-8 h-8 bg-red-100 rounded-lg flex items-center justify-center">
                          <Bike size={15} className="text-red-600" />
                        </div>
                        <div>
                      ...
                      <div className="bg-gray-50 rounded-xl p-3 space-y-1">
                        <div className="flex items-center justify-between">
                          ...
                          <button onClick={() => copyCredentials(rider)} className="flex items-center gap-1 text-red-700" style={{ fontSize: '0.72rem' }}>
              ...
              {[
                ...
                <div key={f.k}>
                  ...
                  <input
                    ...
                    className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${riderErrors[f.k] ? 'border-red-300' : 'border-gray-200 focus:border-red-600'}`}
                  />
                  {riderErrors[f.k] && <p className="text-red-700 text-xs mt-0.5">{riderErrors[f.k]}</p>}
                </div>
              ))}
            </div>
