    ...
    <MobileLayout>
      ...
      <div className="bg-gradient-to-r from-red-800 to-red-700 px-5 pt-10 pb-5">
        ...
        <div className="relative flex flex-col gap-1 mt-4">
            ...
            {statusTabs.map(status => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm transition-all ${activeFilter === status ? 'bg-white text-red-800 shadow-lg' : 'bg-red-200 text-red-900'}`}
          ...
          {/* sliding indicator */}
          <div
            className="absolute bottom-0 h-0.5 bg-red-800 transition-all"
            style={{
              ...
              >
                ...
                <div className="mb-3 space-y-1">
                  ...
                  <div className="border-t border-gray-100 pt-1 mt-1 flex justify-between">
                    ...
                    <span className="text-red-800 text-sm" style={{ fontWeight: 700 }}>Rs. {order.total}</span>
                  </div>
                </div>

                {order.riderName && (
                  <div className="inline-flex items-center gap-1 bg-red-50 px-3 py-1.5 rounded-full mb-3">
              ...
              <div className="space-y-2 mb-4">
                {orgRiders.map(rider => (
                  <button
                    ...
                    className="w-full flex items-center gap-3 p-3.5 border-2 border-gray-100 rounded-xl hover:border-red-500 hover:bg-red-50 transition-all text-left"
                  >
                    <div className="w-9 h-9 bg-red-100 rounded-xl flex items-center justify-center">
                      <Bike size={17} className="text-red-600" />
                    </div>
                    <div>
