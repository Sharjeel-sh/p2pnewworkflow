      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 bg-stone-100" onClick={() => setOpenMenuRiderId(null)}>
        <div className="flex items-center justify-between gap-3 mb-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 bg-orange-500 text-white px-3.5 py-2 rounded-xl shadow-sm hover:bg-orange-600 transition-colors flex-shrink-0"
                ...
                <div key={rider.id} className="bg-white rounded-2xl p-4 shadow-sm border border-stone-200">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3 min-w-0">
                      <div className="w-12 h-12 rounded-full overflow-hidden bg-orange-50 border border-orange-200 flex items-center justify-center text-orange-600 flex-shrink-0">
                ...
                <>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full border-2 rounded-xl px-3 py-2.5 text-sm focus:outline-none bg-gray-50 ${errors.confirmPassword ? 'border-red-300' : 'border-gray-200 focus:border-orange-400'}`}
                    />
